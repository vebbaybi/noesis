...
from noesis_agent.audio.transcription import StreamingTranscriber, TranscriptionPipeline
...
from noesis_agent.models.schemas import Session, SessionPlatformState
from noesis_agent.platforms.discord_space import build_discord_adapter_from_settings
...
class LiveMediaAgent:
    ...
    def __init__(self, *, data_dir, openai_service, host_service=None) -> None:
        ...
        self.episodic_memory = EpisodicMemory(data_dir=data_dir)
        ...
        if host_service is None:
            ...
            host_service = HostService(openai_service=openai_service, brain_service=brain_service)
    ...
    async def _transcript_consumer_loop(self) -> None:
        ...
        while True:
            ...
            self.working_memory.add(events)
            self.episodic_memory.append(self._session_id or "live", events)
