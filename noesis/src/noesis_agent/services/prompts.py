...
This service is intentionally thin: prompt assets live in `noesis_agent.config`
...
from noesis_agent.config import DEFAULT_INLINE_TEMPLATES, DEFAULT_PENTAGON_FALLBACK, deep_merge_dicts, settings
...
class PromptConfig:
    ...
    def _load_prompt_modules(self) -> None:
        try:
            from noesis_agent.prompts import (
                cohost_prompts,
                guest_prompts,
                host_prompts,
                moderation_prompts,
