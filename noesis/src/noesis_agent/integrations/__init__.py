"""Concrete external platform, provider, HTTP, and optional audio adapters."""
...
def __getattr__(name: str):
    module_map = {
        "DiscordSpaceAdapter": (".discord.space", "DiscordSpaceAdapter"),
        "build_discord_adapter_from_settings": (
            ".discord.space",
            "build_discord_adapter_from_settings",
        ),
        "XSpaceAdapter": (".x.space", "XSpaceAdapter"),
