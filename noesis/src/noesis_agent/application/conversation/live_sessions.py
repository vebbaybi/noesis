...
from noesis_agent.domain.contracts.live import LiveEventIngestionResult, LiveEventType, LiveSessionEventRequest
from noesis_agent.domain.contracts.runtime import AudienceSignal, SessionContext, SpeakerState
from noesis_agent.domain.contracts.session import SessionState
from noesis_agent.domain.entities.transcript import SessionTranscriptEvent, TranscriptEvent, TranscriptEventType
...
class LiveSessionService:
    ...
    def _build_context(self, state: SessionState) -> SessionContext:
        ...
        memories = self.memory.recall(active_topic or "general", session_id=state.session_id, limit=6)
