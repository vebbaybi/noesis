...
from noesis_agent.config.settings import SettingsIssue, settings
from noesis_agent.core.shutdown import ShutdownManager
...
class ApplicationLifecycle:
    ...
    def __init__(self) -> None:
        self.logger = NoesisLogger(
            logger_name="noesis_agent.core.lifecycle",
