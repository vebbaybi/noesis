...
class PlanEpisodeCommand(BaseCommand):
    ...
    async def execute(self, payload: dict[str, Any]) -> str:
        ...
        from noesis_agent.models.schemas import EpisodePlanRequest, Topic
...
class ChatCommand(BaseCommand):
    ...
    async def execute(self, payload: dict[str, Any]) -> str:
        ...
        from noesis_agent.models.live import HostTurnRequest, LiveEventType, LiveSessionEventRequest, OutputChannel
